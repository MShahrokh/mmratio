function Class = Class_LDA(Point,Data0,Data1)
...
if n0< 1
    %     SigmaHat0 = 0;
    SigmaHat1 = cov(Data1);
    SigmaHat = ((n1-1)*SigmaHat1)/(n0+n1-1);
    
elseif n1< 1
    %     SigmaHat1 = 0;
    SigmaHat0 = cov(Data0);
    SigmaHat = ((n0-1)*SigmaHat0)/(n0+n1-1);
...
if n0+n1<size(Data0,2)+1
    SigmaHat = ShrinkageCov([Data0;Data1],n0+n1);
end
% %     end
